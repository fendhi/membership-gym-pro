...
<body class="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 min-h-screen">
        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between py-4">
                <div class="flex items-center space-x-2 md:space-x-4">
                    <a href="dashboard.php" class="flex items-center space-x-1 md:space-x-2 hover:text-gray-300 transition">
                        <i class="fas fa-arrow-left"></i>
                        <span class="hidden md:inline">Kembali</span>
                    </a>
                    <div class="flex items-center space-x-2">
                        <i class="fas fa-weight text-xl md:text-2xl text-gray-400"></i>
                        <span class="text-base md:text-xl font-bold">Catatan BB</span>
                    </div>
                </div>
                <div class="flex items-center space-x-2 md:space-x-4">
                    <a href="cetak_bb.php" class="hidden md:flex bg-gray-600 hover:bg-gray-700 px-4 py-2 rounded-lg transition items-center">
    ...
    <!-- Mobile: Tombol Unduh PDF di luar navbar -->
    <div class="md:hidden container mx-auto px-4 py-3 flex justify-end">
        <a href="cetak_bb.php" class="bg-gray-600 hover:bg-gray-700 px-4 py-2 rounded-lg transition text-sm text-white">
            <i class="fas fa-download mr-2"></i>Unduh PDF
        </a>
    </div>
                ...
                <form method="POST" class="space-y-4">
                    <div>
                        ...
                        <input type="date" name="tanggal" value="<?php echo date('Y-m-d'); ?>" required
                            class="w-full px-3 py-2 md:px-4 md:py-3 bg-white/10 border border-white/30 rounded-lg text-white text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-gray-400">
                    </div>
                    <div>
                        ...
                        <input type="number" name="berat" step="0.1" min="1" max="500" placeholder="Contoh: 70.5" required
                            class="w-full px-3 py-2 md:px-4 md:py-3 bg-white/10 border border-white/30 rounded-lg text-white text-sm md:text-base placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400">
                    </div>
                    <div>
                        ...
                        <textarea name="catatan" rows="2" placeholder="Contoh: Setelah olahraga"
                            class="w-full px-3 py-2 md:px-4 md:py-3 bg-white/10 border border-white/30 rounded-lg text-white text-sm md:text-base placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400"></textarea>
                    </div>
                    <button type="submit" name="simpan_berat" class="w-full bg-gradient-to-r from-gray-600 to-gray-700 text-white px-4 py-2 md:px-6 md:py-3 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition font-semibold text-sm md:text-base">
